...
export default function AdminTasks() {
    ...
    const [categories, setCategories] = useState<string[]>(['Youtube', 'Tasks list', 'Race']); // Added 'Race' here
    ...
    const fetchTasks = useCallback(async () => {
        ...
        try {
            ...
            setCategories(prevCategories => [...new Set([...prevCategories, ...uniqueCategories])]); // Combine and avoid duplicates
        } catch (error) {
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="mb-12 bg-[#272a2f] rounded-lg p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {(taskType === TaskType.VISIT || taskType === TaskType.TELEGRAM || taskType === TaskType.REFERRAL) && (
                            <div>
                                <input
